    ...
    <el-container style="height: 500px; border: 1px solid #eee">
        <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
            <el-menu>
                ...
                <el-submenu index="2">
                    <template slot="title"><i class="el-icon-menu"></i>功能一览</template>
                    <el-menu-item-group>
                    ...
                    <el-menu-item-group>
                        ...
                        <el-menu-item index="2-2" @click="view_my_commodity">我的发布</el-menu-item>

                        <el-menu-item index="2-2" @click="view_my_bought">我的订单</el-menu-item>
        ...
        <!-- 查看我的购买对话框 -->
        <el-dialog title="我的订单" :visible.sync="dialogMyBoughtVisible">
        ...
        <el-dialog title="发布商品" :visible.sync="dialogFormVisible">
            <el-form :model="commodityForm" label-width="100px" class="demo-ruleForm" :rules="rules"
                ...
                <el-form-item>
                    <el-button style="width: 100%" type="primary" @click="submitForm('commodityForm')">创建商品</el-button>
