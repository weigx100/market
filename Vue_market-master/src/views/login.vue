  ...
  <div>
    <el-card class="login-form-layout">
      <el-form autocomplete="on" :model="loginForm" ref="loginForm" label-position="left">
        ...
        <h2 class="login-title color-main">欢迎登录二手商品平台</h2>
        ...
        <el-form-item style="margin-bottom: 60px">
          <el-button style="width: 100%" type="primary" :loading="loading" @click.native.prevent="handleAdminLogin">
            管理员登录
          </el-button>
        </el-form-item>
        <div style="text-align:right">
          <el-button type="text" @click="toRegisterPage">还没有账号？点我注册</el-button>
        </div>
